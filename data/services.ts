...
export const services: Service[] = [
  {
    ...
    tagline: 'Strategic guidance to adopt secure, independent technology without legacy lock-in.',
  ...
  },
  {
    ...
    tagline: 'Tailored applications built for portability, performance, and long-term control.',
  ...
  },
  {
    ...
    tagline: 'Move workloads off dominant platforms with a secure, phased migration strategy.',
  ...
  {
    name: 'Ethical Agentic AI',
    tagline: 'Deploy practical AI agents with transparent governance and responsible data practices.',
  ...
  {
    name: 'Websites',
    tagline: 'High-performance websites that convert, communicate credibility, and stay easy to operate.',
