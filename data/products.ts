export interface Product {
  ...
  url?: string
  image?: string
  status: 'delivered' | 'incubation' | 'development'
  tagline: string
  description: string
...
export const products: Product[] = [
  {
    name: 'Commit 250',
    image: '/images/commit250.png',
    url: 'https://commit250.com',
    status: 'delivered',
    tagline: 'Build discipline-driven health momentum through a guided, community-powered daily challenge.',
  ...
  },
  {
    ...
    image: '/images/jordan-rivera.png',
    url: 'https://sih.reqtec.com',
    status: 'incubation',
    tagline: 'Unify practitioner workflows and patient engagement in one compliance-first care platform.',
    ...
    targetCustomer: 'SMB Integrative and Functional Health Clinics',
  },
  {
    name: 'Enthous.IO',
    ...
    status: 'incubation',
    tagline: 'Accelerate financial model research with reproducible testing, governance, and risk visibility.',
    ...
    targetCustomer: 'Small financial investment firms searching for the edge.',
  },
  {
    name: 'DEALVR',
    image: '/images/dealvr.png',
    status: 'incubation',
    tagline: 'Help local merchants compete with national logistics through a trusted neighborhood delivery network.',
  ...
  {
    name: 'HANNO',
    image: '/images/hanno.jpg',
    status: 'development',
    tagline: 'Replace Big Tech dependencies with a guided path to resilient, sovereign infrastructure choices.',
