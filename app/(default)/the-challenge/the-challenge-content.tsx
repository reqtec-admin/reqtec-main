...
export default function TheChallengeContent() {
  return (
    <div className="min-h-screen">
        ...
        <div className="prose prose-invert max-w-none">
          ...
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
            <Link href="/our-vision" className="text-teal-400 hover:text-teal-300 transition duration-150 ease-in-out inline-flex items-center gap-2">
              Explore our vision and services
      ...
      <ArticleSection animationDelay={200}>
        <div className="prose prose-invert max-w-none">
          <h2 className="text-3xl md:text-4xl font-light tracking-wide mb-6 text-gray-100">Related</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Link href="/our-vision" className="block p-6 border border-white/10 rounded-lg hover:border-teal-500/40 transition no-underline">
              ...
              <p className="text-base text-gray-400">Alternative technology services and consulting outside Big Tech.</p>
            </Link>
            <Link href="/services/cloud-migrations" className="block p-6 border border-white/10 rounded-lg hover:border-teal-500/40 transition no-underline">
              <h3 className="text-xl font-light text-gray-100 mb-2">Cloud Migrations</h3>
              <p className="text-base text-gray-400">Move off Google Cloud, AWS, and Azure to independent infrastructure.</p>
            </Link>
            <Link href="/services/ethical-agentic-ai" className="block p-6 border border-white/10 rounded-lg hover:border-teal-500/40 transition no-underline">
              <h3 className="text-xl font-light text-gray-100 mb-2">Ethical Agentic AI</h3>
              <p className="text-base text-gray-400">Deploy practical AI agents with transparent governance and responsible data practices.</p>
            </Link>
          </div>
        </div>
      </ArticleSection>
